...
from PyQt5.QtWidgets import (
    ...
    QSplitter, QGroupBox, QDialog, QColorDialog
)
from PyQt5.QtGui import QPainter, QColor, QPen, QFont
from PyQt5.QtCore import Qt, QRectF
from moviepy import VideoFileClip

# --- Widget para vista de posición del elemento ---
class ElementPreviewWidget(QWidget):
    def __init__(self, layout_sections, parent=None):
        super().__init__(parent)
        self.layout_sections = layout_sections  # Divs de 1080x1920
        self.current_div_id = None
        self.offset_x = 0
        self.offset_y = 0
        # Tamaño de vista reducido (puede variar)
    ...
    def paintEvent(self, event):
        ...
        # Mostrar área total de trabajo
        painter.setFont(QFont("Arial", 8))
        painter.drawText(5, self.height()-5, "Área de trabajo: 1080 x 1920")
        # Resaltar div seleccionado y marcar centro (div.x+offset, div.y+offset)
...
# --- Ventana de Línea de Tiempo (separada) ---
...
class TimelineGlobalWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        w = self.width()
        if overall_duration <= 30:
            tick_interval = 1
        elif overall_duration <= 60:
            tick_interval = 5
        else:
            tick_interval = 10
...
# --- Editor de Elementos y Segmentos ---
class ElementEditorNew(QWidget):
    def __init__(self, layout_config):
        ...
        self.elements_data = []  # Cada elemento: id, div, offset y lista de segmentos.
        self.timeline_window = None
        self.initUI()
    def initUI(self):
        self.main_layout = QVBoxLayout()
        self.splitter = QSplitter(Qt.Horizontal)
        # Lista de elementos (lado izquierdo)
        ...
        # Vista de posición con scroll vertical
        ...
        self.seg_start_spin = QDoubleSpinBox()
        self.seg_start_spin.setRange(0,10000)
        self.seg_start_spin.setDecimals(2)
        self.seg_start_spin.setSingleStep(0.1)
        self.seg_end_spin = QDoubleSpinBox()
        self.seg_end_spin.setRange(0,10000)
        self.seg_end_spin.setDecimals(2)
        self.seg_end_spin.setSingleStep(0.1)
        self.seg_type_combo = QComboBox()
        self.seg_type_combo.addItems(["Texto", "Imagen", "GIF", "Video"])
        ...
        # Botón para actualizar el elemento actual
        ...
        # Botón para abrir la ventana de línea de tiempo
        ...
        # Conectar cambios en div y offset para actualizar preview
    ...
    def load_segment(self, index):
        ...
        if content_type == "Texto":
            # Actualizar el botón de color con el valor almacenado (se asume que es un string hexadecimal)
